...
# pipeline.jl has just written apred/<mjd>/exposureTypeCheck_*.h5 for every
# telescope; fold those into the almanac so make_runlist_fiber_flats.jl below
# can drop known-bad flats BEFORE trace fitting rather than having the trace
