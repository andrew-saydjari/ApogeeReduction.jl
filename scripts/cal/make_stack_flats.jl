...
using ApogeeReduction: cal2df, load_gain_maps, get_cal_file, gen_design_mat, grow_msk2d, nanzeromedian, 
                    nanzeroiqr, safe_jldsave, bad_pix_bits, get_cal_path, dark_pix_bits, bad_flat_pix_bits
...
#hard coded for now
gainReadCalDir = "/uufs/chpc.utah.edu/common/home/u6039752/scratch1/working/2025_06_03/pass_clean/"
...
close(f)
bad_pix_dark = (dark_pix_bitmask[5:2044, 5:2044] .& dark_pix_bits .!= 0);
