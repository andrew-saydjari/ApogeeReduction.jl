...
#SBATCH --job-name=ApogeeReduction_objects
...
runname="objects_${tele}_${mjd_start}_${mjd_end}"
outdir="../outdir/"
doutdir=$outdir
...
julia +1.11.0 --project="./" src/cal_build/make_runlist_objects.jl --tele $tele --almanac_file $almanac_file --output $runlist
