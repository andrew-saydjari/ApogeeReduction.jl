...
"""
    submatrix_inv_mult(M, Minv, imask, Y, MinvY; irange=nothing, pad=false, bruteforce=false) -> Ainvy
...
2021-Oct-21 - Originally written by Douglas Finkbeiner, CfA. 
https://github.com/dfink/gspice/blob/main/julia/gspice.jl
"""
function submatrix_inv_mult(M, Minv, imask, Y, MinvY)
    # COMMENTS:
